 ...
 *
 * This function uses [LazyListScope.lazyPagingItemsIndexed], passing the [itemKey], [itemContentType], [itemPlaceholderContent] and [itemContent] to it.
 *
 ...
 *
 * @see LazyListScope.lazyPagingItemsIndexed
 */
inline fun <T : Any> LazyListScope.lazyPagingItemsIndexedStates(
	...
	crossinline itemPlaceholderContent: @Composable (LazyItemScope.(index: Int) -> Unit) = {},
