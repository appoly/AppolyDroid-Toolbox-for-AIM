...
implementation("com.github.appoly.AppolyDroid-Toolbox:LazyListPagingExtensions:1.0.20-rc05") // For LazyColumn
implementation("com.github.appoly.AppolyDroid-Toolbox:LazyGridPagingExtensions:1.0.20-rc05") // For LazyGrid
```
