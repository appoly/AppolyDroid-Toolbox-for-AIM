...
implementation("com.github.appoly.AppolyDroid-Toolbox:LazyListPagingExtensions:1.0.24") // For LazyColumn
implementation("com.github.appoly.AppolyDroid-Toolbox:LazyGridPagingExtensions:1.0.24") // For LazyGrid
```
