...
implementation("com.github.appoly.AppolyDroid-Toolbox:LazyListPagingExtensions:1.0.22-rc01") // For LazyColumn
implementation("com.github.appoly.AppolyDroid-Toolbox:LazyGridPagingExtensions:1.0.22-rc01") // For LazyGrid
```
